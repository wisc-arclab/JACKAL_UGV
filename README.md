...
3. For NMPC control using ACADO (real world with mocap optitrack), please see [`ACADO_MOCAP_NMPC`](https://github.com/wisc-arclab/JACKAL_UGV/tree/ACADO_MOCAP_NMPC) branch.
